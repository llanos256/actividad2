...
ActiveRecord::Schema.define(version: 2021_05_30_003727) do

  create_table "comparendos", force: :cascade do |t|
    t.float "valor"
    t.date "fecha"
    t.boolean "estado"
    ...
    t.index ["Prestamo_id"], name: "index_comparendos_on_Prestamo_id"
  end
  ...
  add_foreign_key "comparendos", "Prestamos"
